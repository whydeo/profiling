        ...
        <div class="col-xl-12 col-md-12">
                ...
                {{-- @foreach ($tampil as $item) --}}
                                                  ...
                                                  <div class="card-body">
                                                    ...
                                                    <form action="{{route('influencer.update',$item->id)}}" method="POST" enctype="multipart/form-data">
                                                      @csrf 
                                                        <div class="form-row">
                                                          <div class="form-group col-md-6">
                                                            <label for="inputnama4">full name</label>
                                                            <input type="nama" class="form-control" name="nama" id="inputnama4" value="{{$item->nama}}">
                                                          </div>
                                                          <div class="form-group col-md-6">
                                                            <label for="inputheadline4">headline</label>
                                                            <input type="headline" class="form-control" name="headline" id="inputheadline4" value="{{$item->headline}}">
                                                        ...
                                                        <div class="form-group">
                                                          ...
                                                          <input type="text" class="form-control" name="alamat" id="inputAddress" placeholder="jakarta,Indonesia" value="{{$item->alamat}}">
                                                        </div>
                                                   <div class="form-row">
                                                    <div class="col-md-6" >
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <p class="form-inline">
                                                            ...
                                                            <div class="input-group">
                                                              <input class="form-control date-picker" value="{{$item->birthday}}" placeholder="YYYY-mm-dd" type="date" name="birthday" id="account_birthday" />
                                                            </div>
                                                            </p>
                                                        <div class="form-row">
                                                          <div class="form-group col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                              <input placeholder="e.g. $500 / IDR.7440550,00" step="1" max="50000" class="form-control" type="number" name="minimum_price" value="{{$item->minimum_price}}" id="account_minimum_rate" />
                                                            </div>
                                                          </div>
                                                        
                                                          <div class="form-group col-md-6 mt-5">
                                                            <label for="account_bio">Bio</label> <small class="text-muted pull-right">Max 5000 characters.</small><br>
                                                            <textarea class="form-control" placeholder="Tell the world about yourself here. This is a place to share a lot more information than you can on your Instagram profile." style="min-height: 200px" name="bio" id="account_bio">{{$item->bio}}</textarea>
                                                            <br>
                                                          </div>
